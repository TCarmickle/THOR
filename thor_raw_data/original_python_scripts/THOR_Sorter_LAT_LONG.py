...
OUTFILE = FILENAME + "_Analyzed.csv"
INPUTFILE = FILENAME + ".csv"

##LONGITUDE // left and right
##LATITUDE // up and down

BOUNDBOXSTARTLAT = 25.0
BOUNDBOXSTARTLONG = 120.0
BOUNDBOXENDLAT = 30.0
BOUNDBOXENDLONG = 130.0

#BOUNDBOXSTARTLAT = input ("Enter Bounding Box (Upper Left) Latitude: ")
#BOUNDBOXSTARTLONG = input ("Enter Bounding Box (Upper Left) Longitude: ")
...
#BOUNDBOXENDLAT = input ("Enter Bounding Box (Lower Right) Latitude: ")
#BOUNDBOXENDLONG  = input ("Enter Bounding Box (Lower Right) Longitude: ")

#OKINAWA LL
#			<longitude></longitude>
#			<latitude></latitude>

#LOCATIONSORTER = input("Enter location to sort for: ")
...
with open (INPUTFILE) as ClassFile:
    ...
    for row in reader:
        ...
        if (Lat == "NULL"):
            Lat = "0" #Set to zero because of idiot.
            READLAT = float(Lat)
        ...
        if (Lon == "NULL"):
            Lon = "0" #Set to zero because of idiot.
            READLONG = float(Lon)
...
#BOUNDBOXSTARTLAT = 27.36986004804225
#BOUNDBOXENDLAT = 28.00781230107714

#BOUNDBOXSTARTLONG = 128.3866937809326
#BOUNDBOXENDLONG = 128.2535257862139

        if (READLAT >= 22.5) and (READLAT <= 30.0) and (READLONG >= 122) and (READLONG <= 131.5):
#        if (Country_Name == LOCATIONSORTER):
